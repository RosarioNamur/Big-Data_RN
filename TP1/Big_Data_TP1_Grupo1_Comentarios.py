...
Muy buen trabajo chicos!! El código está muy bien. 
Me gusta que hayan explicado paso a paso lo que hacen. 
Entiendo que muchas de estas cosas las hace ChatGPT, pero cuando
escriben lo que hacen, ahí comienzan a captar lo que hacen los comandos! Muy bien


Algo que les recomendaría para la entrega final es que no exporten taaantos archivos intermedios.
Exporten uno con la base limpia y después de ahí van llamandolo cada vez que tienen que hacer cosas nuevas.

Otra cosa que recomendaría es que hagan un preámbulo, en donde dicen el nombre del trabajo práctico,
los integrantes, la materia, etc, etc, etc.

Por último, definiría el directorio una sola vez al principio e importaría todas las librerías a usar al 
comienzo del script. 

Muy bueno. Felicitaciones!! Se nota que trabajaron un montón.
...
#### COMENTARIO TOMI: ESTOS PAQUETES YA LOS IMPORTARON. CAPAZ UNA BUENA PRACTICA ES PONER TODOS LOS PAQUETES AL COMIENZO
...
#### COMENTARIO TOMI: NO ES NECESARIO QUE CARGUEN EL ARCHIVO OTRA VEZ. YA LO GENERARON ANTES.
#### NO CREO QUE SEA UNA BUENA PRACTICA HACER TAANTAS BASES INTERMEDIAS. CON CORRER TODO EL CODIGO Y EXPORTAR LA BASE FINAL, ES SUFICIENTE.
...
#### COMENTARIOS TOMI: NO PONGAN QUIEN HACE LOS COMENTARIOS.. EL TRABAJO ES UNO SOLO QUE HACE EL GRUPO 
...
print(BaseEPH_limpia["ch04"].unique())

#Lo mismo para el año
print(BaseEPH_limpia["ano4"].unique())
