...
#########   EJERCICIO 2   #########################################################
#Buscamos en el dt las variables que tomen mas de dos categorias, es decir, las categoricas
vars_categ = [col for col in Base_Limpia.columns if Base_Limpia[col].nunique() > 2]
print(vars_categ)
#Manualmente inspeccionamos la lista de variables para eliminar las que no sean categoricas y tomen mas de dos valores distintos. Es decir, variables como nro_hogar.

#En base a la lista anterior, eliminamos las variables no categoricas
vars_filtradas = ['ch03', 'ch07', 'ch08', 'ch09', 'ch10', 'ch12', 'ch14', 'ch15', 'ch16', 'nivel_ed', 'cat_ocup', 'cat_inac', 'pp02e', 'pp03h', 'intensi', 'pp04a', 'pp04c', 'pp04c99', 'pp04g', 'pp05c_1', 'pp05c_2', 'pp05c_3', 'pp05h', 'pp06e', 'pp07a', 'pp07d', 'pp07e', 'pp07j', 'pp07k', 'pp08j3', 'pp09a', 'pp10a', 'pp10e', 'pp11a', 'pp11c', 'pp11c99', 'pp11l', 'pp11m', 'pp11o', 'decocur', 'rdecocur', 'gdecocur', 'adecocur', 'decindr', 'rdecindr', 'gdecindr', 'adecindr', 'decifr', 'rdecifr', 'gdecifr', 'adecifr', 'deccfr', 'rdeccfr', 'gdeccfr', 'adeccfr']
...
for año in [2004, 2024]:
    ...
    ax.legend()
    ax.set_xlim(left=0)  # ingreso no puede ser negativo
    ax.grid(True)
    plt.tight_layout()
    plt.show()
